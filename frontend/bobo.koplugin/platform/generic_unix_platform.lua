...
local SERVER_COMMAND_WORKING_DIRECTORY = os.getenv('BOBO_SERVER_WORKING_DIRECTORY')
local SERVER_COMMAND_OVERRIDE = os.getenv('BOBO_SERVER_COMMAND_OVERRIDE')
local REQUEST_COMMAND_WORKING_DIRECTORY = os.getenv('BOBO_UDS_HTTP_REQUEST_WORKING_DIRECTORY')
local REQUEST_COMMAND_OVERRIDE = os.getenv('BOBO_UDS_HTTP_REQUEST_COMMAND_OVERRIDE')
...
function UnixServer:request(request)
  local requestWithDefaults = {
    ...
    timeout_seconds = request.timeout_seconds or 15,
  }
